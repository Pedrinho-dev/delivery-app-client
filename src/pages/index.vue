<template>
  <v-container class="fill-height d-flex flex-column justify-center align-center" fluid
    ...
    <v-sheet width="100%" max-width="400" color="transparent" class="d-flex flex-column gap-4 pa-4">
      ...
      <v-text-field label="Password" v-model="password" type="password" variant="solo-filled" bg-color="#181e36"
        color="white" class="mb-6 rounded-lg" flat hide-details></v-text-field>

      <v-btn @click="login" color="#00E676" height="50" block class="text-black font-weight-bold mb-4"
        style="border-radius: 12px">
        Login
      </v-btn>

      <div class="text-center">
        <router-link to="/signup" class="text-decoration-none" style="color: #00e676">
